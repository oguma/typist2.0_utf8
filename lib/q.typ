...
Qコースのレッスンでは、標準的なキーボードのタッチタイピングを学習します。
キーボード上の各文字を各レッスンで少しずつ紹介してゆきますが、このコース
を終わった時には、アルファベット、数字、大多数の句読点をタッチタイプで
入力できるようになっていることでしょう。

これまでにタイプの練習をしたことがない人でも、心配は不要です。タイピング
...
Dのキーの上にEのキーがあり、Kのキーの上にはIのキーがあります。これらの位
置をしっかり記憶して下さい。一行何かを入力しようとする時には、まず各指が
ホームポジションにあることを確認して下さい。それ以降は指を見てはいけませ
ん。キーボードによっては、JとF、あるいはKとDに、指で触ってわかるように、
突起があったり、湾曲が深くなっていたりするものもあります。\T
...
このレッスンでは、６つの新しい文字 (H, G, O, U, N, T) とピリオドを覚えま
す。Fの指がGの上に残ったり、Jの指がHの上に動いてしまわないように注意して
下さい。

英文では、ピリオドには常に２つの空白が続くことに注意して下さい。\T
(1) Rhythm Drill\I
...
ここまででは、まず、英語で最も頻繁に使われる文字を学びました。これらは
何度も何度も繰り返し現れます。

英文では、カンマ「,」（コンマ）の後には常に１つの空白を置きます。どんな
句読点で区切られても、文と文の間には２つの空白を置くことを忘れないで下
さい。

コロン「:」はその次にリストを続けるのに利用し、後ろには２つの空白を置き
ます。コロンはキーボードによってキーの位置が異なることがあります。
セミコロン「;」の右隣にある場合と、シフトキーとセミコロンのキーで入力で
きる場合の主に２種類です。どちらの場合でも、右手の小指で入力します。\T
(1) Rhythm Drill\I
...
タイプの練習にはセルフコントロールが重要です。それぞれのキーに対して正し
い指を使えるように集中して下さい。このレッスンでは、アルファベットの残り
の７つの文字を練習します。

セミコロン「;」はカンマのように、文章中では１つの空白を続けます。\T
(1) Rhythm Drill\I
...
もうアルファベットのすべての文字を入力できますね。このレッスンではハイフ
ン「ー」（マイナス記号）と引用符「'」（アポストロフィ）を付け加えます。

これらの記号は、キーボードによって位置が異なることがあります。\T
(1) Rhythm Drill\I
dedc kik, frfv jujm swsx lol. aqaz ;p;p frfv jujm ftfb jyjn
