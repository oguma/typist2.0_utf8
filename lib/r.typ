...
このレッスンでは、数字やいろいろな記号が配置されている、キーボードの一番
上の列について練習します。Fの指が4と5を押し、Jのキーが6と7のキーを押すこ
とに注意して下さい。\T
(1) ウォーミングアップ\I
...
このレッスンでは、キーボード上の他の特殊な記号について学びます。\T
(1) ウォーミングアップ\I
...
#else
k9) d3# j8( f4$ j7' f5% f6& j6& lo0 s2" ;-= ;[] ;! d3# ;/?
k) d# j( f$ j' f% j& f& l0 s" ;= s" ;{ d# ;@ f% ;? f& j& s"
#endif
"A "S "O "W "E *C *P *B e5" t4" u3: h2: u1' n6'\D
(3) Continuous Copy\I
...
as: nt: et; re; us* me* is! de!\D
#else
k) d# j( f$ j' f% j' f& l0 s" ;= d# ;! f% ;! f$ j& s"
(3 8% #9 2) @0 [@ *4 2= $8 [% 3 1/5 3 @ 5 & 3& $7 5* $8 !)
as" nt" et" re" us" me" is" de" it" t." e." r," o," ?" ?" ?"\D
t( e# h* u$ h' u% h' u& n) o@ e# s/ u% s/ u$ h& o@
as: nt: et; re; us* me* is! de!\D
#endif
(3) Continuous Copy\I
